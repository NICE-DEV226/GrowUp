...
import { translateCategory } from '../../src/utils/categoryTranslator';

const { height } = Dimensions.get('window');

// Composant TransactionItem
const TransactionItem = ({ transaction, index, onPress, currencySymbol = '€', language = 'Français', t }: any) => {
    ...
    >
      ...
      >
        ...
        <View style={styles.transactionDetails}>
          <Text style={styles.transactionCategory}>{translateCategory(transaction.category, t)}</Text>
...
export default function Transactions() {
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      ...
      // Déclencher le rafraîchissement dans toutes les pages
      ...
      Alert.alert(t('error'), error.response?.data?.error || t('cannotCreateTransaction'));
    }
  };
        ...
        >
          <View style={styles.statCard}>
            ...
            <View style={styles.statInfo}>
              ...
              <Text style={styles.statValue} numberOfLines={1} adjustsFontSizeToFit>
                {formatSmartAmount(totalIncome, currency, 10)}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.statCard}>
            ...
            <View style={styles.statInfo}>
              ...
              <Text style={styles.statValue} numberOfLines={1} adjustsFontSizeToFit>
                {formatSmartAmount(totalExpense, currency, 10)}
              </Text>
            </View>
          </View>
        </Animated.View>
          ...
          {filteredTransactions.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>
                {searchQuery ? t('noData') : t('noTransactionsDesc')}
              </Text>
            </View>
          ) : (
            <React.Fragment>
              ...
              <View key="spacer" style={{ height: 100 }} />
            </React.Fragment>
          )}
        </ScrollView>
      </Animated.View>
          ...
          >
            ...
            <View style={styles.detailsContent}>
              <View style={styles.detailRow}>
                ...
                <View style={styles.detailInfo}>
                  ...
                  <Text style={styles.detailValue}>
                    {selectedTransaction && formatDate(selectedTransaction.date, language, { 
                      day: 'numeric', 
                      month: 'long',
                      year: 'numeric'
                    })}
              ...
              <View style={styles.detailRow}>
                ...
                <View style={styles.detailInfo}>
                  <Text style={styles.detailLabel}>{t('account')}</Text>
                  <Text style={styles.detailValue}>{t('mainAccount')}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.detailsActions}>
              ...
              >
                ...
                <Text style={[styles.actionButtonText, styles.actionButtonTextDanger]}>{t('delete')}</Text>
              </TouchableOpacity>
            </View>
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>{t('editTransaction')}</Text>
              <TouchableOpacity 
                  ...
                  {editType === 'expense' ? (
                    <>
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Nourriture' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('food')}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity 
                        key="housing"
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Logement' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('housing')}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity 
                        key="transport"
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Transport' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('transport')}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity 
                        key="shopping"
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Shopping' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('shopping')}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity 
                        key="health"
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Santé' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('health')}</Text>
                      </TouchableOpacity>
                    </>
                  ) : (
                    <>
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Salaire' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('salary')}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity 
                        key="freelance"
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Freelance' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('freelance')}</Text>
                      </TouchableOpacity>
                      <TouchableOpacity 
                        key="investment"
                      ...
                      >
                        ...
                        <Text style={editCategory === 'Investissement' ? styles.categoryChipTextActive : styles.categoryChipText}>{t('investment')}</Text>
                      </TouchableOpacity>
                    </>
                  )}
                </ScrollView>
          ...
          <View style={styles.calendarModal}>
            <View style={styles.calendarHeader}>
              ...
              <Text style={styles.calendarTitle}>
                {formatDate(calendarMonth, language, { month: 'long', year: 'numeric' })}
              </Text>
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>{t('newTransaction')}</Text>
              <TouchableOpacity 
                style={styles.modalCloseButton}
                onPress={() => setAddVisible(false)}
              >
              ...
              <View style={styles.formSection}>
                ...
                <View style={styles.typeSelector}>
                  <TouchableOpacity 
                    style={[
                      styles.typeButton, 
                      addType === 'expense' && styles.typeButtonExpenseActive
                    ]}
                  ...
                  >
                    <MaterialCommunityIcons 
                      name="arrow-down" 
                      size={20} 
                      color={addType === 'expense' ? '#fff' : 'rgba(253, 253, 253, 0.6)'} 
                    />
                    <Text style={addType === 'expense' ? styles.typeButtonTextActive : styles.typeButtonText}>
                      {t('expenseType')}
                    </Text>
                  </TouchableOpacity>
                  <TouchableOpacity 
                    style={[
                      styles.typeButton, 
                      addType === 'income' && styles.typeButtonIncomeActive
                    ]}
                  ...
                  >
                    <MaterialCommunityIcons 
                      name="arrow-up" 
                      size={20} 
                      color={addType === 'income' ? '#fff' : 'rgba(253, 253, 253, 0.6)'} 
                    />
                    <Text style={addType === 'income' ? styles.typeButtonTextActive : styles.typeButtonText}>
                      {t('incomeType')}
                    </Text>
                  </TouchableOpacity>
                </View>
              ...
              <View style={styles.formSection}>
                ...
                >
                  {addType === 'expense' ? (
                    <>
                      {[
                        { key: 'Nourriture', label: t('food') },
                        { key: 'Transport', label: t('transport') },
                        { key: 'Logement', label: t('housing') },
                        { key: 'Shopping', label: t('shopping') },
                        { key: 'Santé', label: t('health') },
                        { key: 'Loisirs', label: t('entertainment') }
                      ].map((cat) => (
                        <TouchableOpacity 
                          key={cat.key}
                          style={[
                            styles.categoryChip,
                            addCategory === cat.key && styles.categoryChipActive
                          ]}
                          onPress={() => setAddCategory(cat.key)}
                        >
                          <Text style={addCategory === cat.key ? styles.categoryChipTextActive : styles.categoryChipText}>
                            {cat.label}
                          </Text>
                        </TouchableOpacity>
                      ))}
                    ...
                    <>
                      {[
                        { key: 'Salaire', label: t('salary') },
                        { key: 'Freelance', label: t('freelance') },
                        { key: 'Investissement', label: t('investment') },
                        { key: 'Cadeau', label: t('gift') },
                        { key: 'Autre', label: t('other') }
                      ].map((cat) => (
                        <TouchableOpacity 
                          key={cat.key}
                          style={[
