...
export default function Dashboard() {
  const { user, currency, language } = useAuthStore();
  ...
  const getTimeAgo = (dateString: string) => {
    ...
    if (diffDays < 7) return `${t('daysAgo').replace('{days}', diffDays.toString())}`;
  ...
  // Rafraîchir automatiquement quand des données changent dans d'autres pages
  useEffect(() => {
    if (refreshTrigger > 0) {
      loadDashboardData();
    }
      ...
      >
            ...
            <View style={styles.balanceTop}>
              <View style={styles.balanceLeft}>
                ...
                <Text style={styles.balanceAmount} numberOfLines={1} adjustsFontSizeToFit>
                  {loading ? '...' : formatSmartAmount(balance, currency, 12)}
                </Text>
              </View>
            ...
            <View style={styles.balanceStats}>
              <View style={styles.statItem}>
                ...
                <View style={styles.statInfo}>
                  ...
                  <Text style={styles.statValue} numberOfLines={1} adjustsFontSizeToFit>
                    {loading ? '...' : formatSmartAmount(income, currency, 10)}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.statItem}>
                ...
                <View style={styles.statInfo}>
                  ...
                  <Text style={styles.statValue} numberOfLines={1} adjustsFontSizeToFit>
                    {loading ? '...' : formatSmartAmount(expense, currency, 10)}
                  </Text>
                </View>
              </View>
            </View>
        ...
        >
          ...
          >
            ...
            <Text style={styles.quickActionText}>{t('add')}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.quickActionText}>{t('transfer')}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.quickActionText}>{t('stats')}</Text>
          </TouchableOpacity>
        ...
        >
          ...
          {loading ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>{t('noTransactionsDesc')}</Text>
              <TouchableOpacity 
                style={styles.emptyButton}
                onPress={openAddTransaction}
              >
                <Text style={styles.emptyButtonText}>{t('addTransaction')}</Text>
              </TouchableOpacity>
            </View>
          )}
        </Animated.View>
        ...
        >
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>{t('myGoals')}</Text>
          ...
          {loading ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>{t('noGoalsDesc')}</Text>
              <TouchableOpacity 
                style={styles.emptyButton}
                onPress={() => router.push('/(tabs)/goals')}
              >
      ...
      >
        <View style={styles.calendarOverlay}>
          <View style={styles.initialBalanceModal}>
            ...
            <Text style={styles.initialBalanceTitle}>{t('welcomeExclamation')}</Text>
            <Text style={styles.initialBalanceText}>
              {t('initialBalanceMessage')}
            </Text>
